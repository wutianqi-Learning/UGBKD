...
from razor.models.losses.mskd_cakd import MSKD_CAKD_FNKD
...
model = dict(
    ...
    distiller=dict(
        ...
        student_recorders=dict(
            ...
            up_layer1_in=dict(type=ModuleInputsRecorder, source='segmentor.backbone.up_layer1'),
            up_layer2_in=dict(type=ModuleInputsRecorder, source='segmentor.backbone.up_layer2'),
            up_layer3_in=dict(type=ModuleInputsRecorder, source='segmentor')
        ),
        teacher_recorders=dict(
            ...
            up_layer3=dict(type=ModuleOutputsRecorder, source='segmentor'),
            up_layer1_in=dict(type=ModuleInputsRecorder, source='segmentor.backbone.decoder3'),
            up_layer2_in=dict(type=ModuleInputsRecorder, source='segmentor.backbone.decoder2'),
            up_layer3_in=dict(type=ModuleInputsRecorder, source='segmentor')
        ),
        distill_losses=dict(
            loss_cakd1=dict(
