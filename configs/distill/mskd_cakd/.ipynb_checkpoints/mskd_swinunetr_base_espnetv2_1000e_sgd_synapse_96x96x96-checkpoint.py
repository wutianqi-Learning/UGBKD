...
model = dict(
    ...
    distiller=dict(
        ...
        student_recorders=dict(
            ...
            # up_layer3_in=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.bu_dec_l4'),
        ...
        distill_losses=dict(
            loss_cakd1=dict(type=CAKD, interpolate=True, loss_weight=0.4),
            loss_cakd2=dict(type=CAKD, interpolate=True, loss_weight=0.4),
