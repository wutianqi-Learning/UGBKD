...
model = dict(
    ...
    distiller=dict(
        ...
        teacher_recorders=dict(
            up_layer1=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.decoder4'),
            up_layer2=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.decoder3'),
            up_layer3=dict(type=ModuleOutputsRecorder, source='segmentor')
        ),
        distill_losses=dict(
            loss_cakd1=dict(
