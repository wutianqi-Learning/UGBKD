...
model = dict(
    ...
    distiller=dict(
        ...
        student_recorders=dict(
            # feat1=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.bu_dec_l2'),#12
            feat1=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.bu_dec_l3'),#24
            feat2=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.bu_dec_l4'),#48
            logits=dict(type=ModuleOutputsRecorder, source='segmentor'),#96
