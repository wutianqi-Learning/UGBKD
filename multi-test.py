...
from seg.utils.train_single_fold import test_single_run, RUN_INFO_FILE, test_run_with_checkpoint
...
if __name__ == '__main__':
    ...
    if os.path.isfile(args.work_dir):
        ...
        experiment_name = osp.basename(cfg.work_dir)
        test_run_with_checkpoint(cfg, ckpt_dir)
    else:
