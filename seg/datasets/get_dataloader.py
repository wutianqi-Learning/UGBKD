...
def BTCV_loader(args: ConfigType, test_mode: bool, save: bool):
    ...
    if test_mode:
        if save:
            test_files = data.load_decathlon_datalist(
                datalist_json, True, 'testing' if args.use_test_data else "validation", base_dir=data_dir)
            ...
            val_files = data.load_decathlon_datalist(
                datalist_json, True, 'testing' if args.use_test_data else "validation", base_dir=data_dir)
